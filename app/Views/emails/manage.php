...
<body style="font-family:Inter,Arial,sans-serif;color:#0f172a;background:#f8fafc;padding:24px">
    <div style="max-width:520px;margin:0 auto;background:#fff;border:1px solid #e2e8f0;border-radius:14px;padding:28px">
        ...
        <p style="font-size:15px;line-height:1.6">Use the button below to edit your business profile. No password needed &mdash; this link signs you in.</p>
        <p style="margin:22px 0">
            <a href="<?= esc($link, 'attr') ?>" style="background:#F77F00;color:#fff;text-decoration:none;font-weight:700;padding:12px 22px;border-radius:11px;display:inline-block">Edit my profile</a>
        </p>
        ...
        <?php if ($offerBadge ?? false): ?>
            ...
            <p style="font-size:13px;color:#64748b">
                While you're there: you can apply for a <strong style="color:#0f172a">Verified Business</strong>
                badge from your dashboard. We check your company registration document and the owner's ID, and
                you only pay &mdash; R<?= esc($badgePrice ?? '') ?> a month &mdash; if they're approved.
